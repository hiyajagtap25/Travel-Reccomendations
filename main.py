    ...
    with st.spinner(''):
        ...
        <div class='places-container'>
            ...
            <div style='display: flex; align-items: center; margin-bottom: 1.5rem;'>
                <div style='height: 1px; flex-grow: 1; background: linear-gradient(90deg, transparent, color:golden;'></div>
                <h3 style='margin: 0 1.5rem; white-space: nowrap;'> Famous Places To Visit</h3>
                <div style='height: 1px; flex-grow: 1; background: linear-gradient(90deg, transparent);'></div>
            </div>
