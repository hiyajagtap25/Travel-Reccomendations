...
# Custom CSS for Premium Dark Pink/Red Theme
st.markdown("""
<style>
    /* Import Premium Font */
    ...
    * {
    ...
    h1 {
        ...
        background: linear-gradient(135deg, #ff1744 0%, #ff6090 50%, #ff1744 100%);
    ...
    [data-testid="stSidebar"] {
        ...
        border-right: 2px solid rgba(255, 23, 68, 0.2);
        padding: 2rem 1rem;
    }
    ...
    .places-container {
        background: linear-gradient(135deg, rgba(255, 23, 68, 0.05) 0%, rgba(26, 10, 15, 0.8) 100%);
    ...
    .loading-spinner {
        width: 50px;
        height: 50px;
        border: 4px solid rgba(255, 23, 68, 0.1);
...
with st.sidebar:
    ...
    country = st.selectbox(
        "Choose A Country",
        ["India", "USA", "China", "Brazil", "Canada", "Italy", "Singapore"],
...
if country:
    with st.spinner(''):
        ...
        # State/Region Header
        st.markdown(f"<h2>✈️ {response['state_name']}</h2>", unsafe_allow_html=True)
